...
function HighEnergyBill(page) {
    const [pageData, setpageData] = useState({});
    page=page.location.pathname.replace('/page/','');

    const pageApi = async () => {
        const pageApiRes = await axios.get('https://www.symbioenergy.co.uk/backend/index.php/api/page/getpage/permalink/reasons-forhighenergy-bills');
    ...
    return (
        <>
            ...
            <title>Reasons for High Energy bills</title>
            <meta name="description" content="Reasons for High Energy bills" />
