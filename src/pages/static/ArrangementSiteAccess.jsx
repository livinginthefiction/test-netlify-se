...
function ArrangementSiteAccess(page) {
    const [pageData, setpageData] = useState({});
    page=page.location.pathname.replace('/page/','');

    const pageApi = async () => {
        const pageApiRes = await axios.get('https://www.symbioenergy.co.uk/backend/index.php/api/page/getpage/permalink/arrangements-for-site-access');
    ...
    return (
        <>
            ...
            <title>Safe and Systematic Home Inspections at Visits Assured by Symbio Energy</title>
            <meta name="description" content="We ensure safe and systematic home inspections for our customers. The engineers at Symbio Energy adheres to the professional decorum" />
...
export default ArrangementSiteAccess
