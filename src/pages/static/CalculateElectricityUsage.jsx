...
function CalculateElectricityUsage(page) {
    const [pageData, setpageData] = useState({});
    page=page.location.pathname.replace('/page/','');

    const pageApi = async () => {
        const pageApiRes = await axios.get('https://www.symbioenergy.co.uk/backend/index.php/api/page/getpage/permalink/how-to-calculate-your-electricity-usage');
    ...
    return (
        <>
            ...
            <title>How to Calculate your Electricity Usage</title>
            <meta name="description" content="How to Calculate your Electricity Usage  " />
...
export default CalculateElectricityUsage
