...
function Privacy(page) {
    ...
    const pageApi = async () => {
        const pageApiRes = await axios.get('https://www.symbioenergy.co.uk/backend/index.php/api/page/getpage/permalink/privacy-policy-cookies');
    ...
    return (
        <>
            ...
            <title>Privacy Policy - A safe and Secure at Symbio Energy UK</title>
            <meta name="description" content="We offer safe and secure privacy policies for our customers. Know more about your policy terms and enjoy stress-free communication with Symbio Energy." />
