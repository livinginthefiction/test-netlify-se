...
function EnergyDebtManagement(page) {
    const [pageData, setpageData] = useState({});
    page=page.location.pathname.replace('/page/','');

    const pageApi = async () => {
        const pageApiRes = await axios.get('https://www.symbioenergy.co.uk/backend/index.php/api/page/getpage/permalink/energy-debt-management');
    ...
    return (
        <>
            ...
            <title>Regarding Energy Depth Management- Symbio Energy UK</title>
            <meta name="description" content="Get the best solutions for Energy Depth Management by Symbio Energy. For any queries feel free to talk with us." />
...
export default EnergyDebtManagement
