...
function Guide(page) {
    ...
    const pageApi = async () => {
        const pageApiRes = await axios.get('https://www.symbioenergy.co.uk/backend/index.php/api/page/getpage/permalink/guides');
    ...
    return (
        <>
            ...
            <title>Refer Guides Regarding all Infromation of our Services, Symbio Energy UK</title>
            <meta name="description" content="Check out the Guides mentioning all details regarding your rights, dept management, tarrif information, arrangement for access etc." />
