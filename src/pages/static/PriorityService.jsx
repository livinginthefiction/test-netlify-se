...
function PriorityService(page) {
    const [pageData, setpageData] = useState({});
    page=page.location.pathname.replace('/page/','');

    const pageApi = async () => {
        const pageApiRes = await axios.get('https://www.symbioenergy.co.uk/backend/index.php/api/page/getpage/permalink/priority-service-register');
    ...
    return (
        <>
            ...
            <title>Symbio Energy now Offers Priority Service to our Unique Customers.</title>
            <meta name="description" content="Receive fast track service by registering for the Priority Service and enjoy a comfortable journey with Symbio Energy, UK." />
