...
function Bill(page) {
    ...
    const pageApi = async () => {
        const pageApiRes = await axios.get('https://www.symbioenergy.co.uk/backend/index.php/api/page/getpage/permalink/tariff-info');
    ...
    return (
        <>
            ...
            <title>Systematically monitor all your Energy Tariff information at Symbio Energy</title>
            <meta name="description" content="View all tariff-related information and guidance only through our customer-friendly services offered at Symbio Energy." />
