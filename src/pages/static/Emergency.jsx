...
function Emergency(page) {
    const [pageData, setpageData] = useState({});
    page=page.location.pathname.replace('/page/','');

    const pageApi = async () => {
        const pageApiRes = await axios.get('https://www.symbioenergy.co.uk/backend/index.php/api/page/getpage/permalink/emergencies');
    ...
    return (
        <>
            ...
            <title>Emergency | Energy Helpline | Symbio Energy</title>
            <meta name="description" content="Are you facing any Energy-related Emergencies? Call 105 or contact us. We are here to help you." />
