...
function BusinessQuote(props) {
    ...
    const [quote, setquote] = useState('https://symbiogetquote.co.uk/?property='+props.property+'&postcode=');

    function getPincode(params) {setquote ('https://symbiogetquote.co.uk/?property='+props.property+'&postcode='+params.target.value);}
    return (
        <>
          <section className="p-1 p-lg-5 p-xl-5 py-5">
            <div className="d-flex flex-column flex-lg-row flex-xl-row justify-content-center">
                ...
                <div className="align-items-center justify-content-center text-center py-5">
                    <img src={localStorage.getItem('baseUrl')+props.quote.searchPlanLeftSectionLink} alt={props.quote.searchPlanLeftSectionLinkAltText} className="d-lg-inline-flex d-none d-xl-inline-flex img-rect" />
                    <img src={localStorage.getItem('baseUrl')+props.quote.searchPlanLeftSectionLinkMobile} alt={props.quote.searchPlanLeftSectionLinkAltTextMobile} className="d-inline-flex d-lg-none d-xl-none w-50" />
                </div>
                <div className="align-items-center d-flex flex-column justify-content-center p-2 p-sm-4 p-xl-5">
                    <h4 className="mb-5 text-center">{props.quote.searchPlanText}</h4>
                    <div className="d-flex getQuote-text justify-content-around">
                        <input type="text" placeholder="Postcode" onChange={getPincode} className="pincode-text"/>
                        <a className="buttonCanvas" href={quote}>{props.quote.searchPlanBtn}</a>
                    </div>
                </div>
            </div>
        </section>  
