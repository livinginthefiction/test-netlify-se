console.log( document.getElementById( 'elasticstack' ));

setTimeout(function(){
d = new ElastiStack( document.getElementById( 'elasticstack' ) );
console.log('d');
},1000);
...
const LiquidButton1 = class LiquidButton1 {
  constructor(button) {
...
const buttons1 = document.querySelectorAll('.buttonCanvas');

buttons1.forEach(button => {
  button.liquidButton = new LiquidButton1(button);
})
